...
import { ColorGroup } from "../../inspector/ColorGroup"
            ...
            {currentBrandTab !== "physiotherapy" ? null : (
              <div className="space-y-3">
                ...
                <div className="border-t pt-3 mt-3">
                  <Accordion type="single" collapsible className="w-full border-0 space-y-2">
                    {/* Group 1: General Colors */}
                    <ColorGroup
                      title="Allgemein"
                      previewColor={String(props.heroBgColor || "")}
                    >
                      <div className="space-y-3">
                        <div className="space-y-1.5">
                    ...
                    <ColorGroup
                      ...
                      previewColor={String((brandContent as Record<string, unknown>).headlineColor || "")}
                    >
                      <div className="space-y-3">
                        <div className="space-y-1.5">
