...
export function ThemeTokenSettingsSection({ settings, setSettings, isSaving }: SettingsTabProps) {
  ...
  return (
    <SettingsSectionCard title={s.themeTitle} description={s.themeDescription}>
      <SettingsInlineHint>{s.themeTokenGuidance}</SettingsInlineHint>
